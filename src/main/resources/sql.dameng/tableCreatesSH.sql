...
) using partition group tpcc_group by (w_id) ;
...
) using partition group tpcc_group by (d_w_id) ;
...
)  using partition group tpcc_group by (c_w_id) ;
...
create table bmsql_history (
  ...
  h_amount float,
  h_data   varchar(24)
) using partition group tpcc_group by (h_w_id) ;
...
) using partition group tpcc_group by (o_w_id) ;
...
) using partition group tpcc_group by (no_w_id) ;
...
) using partition group tpcc_group by (ol_w_id) ;
...
) using partition group tpcc_group by (s_w_id) ;
